...
<button onClick='showChatbot()' style="position: fixed; bottom: 0; right: 20px; width: 100px;height: 100px;border-radius: 50%;z-index:1000;background-color: #2b313f; color: white">Open Hygiea</button>
<div>
    <button onClick='hideChatbot()' style="position: fixed; bottom: 450px; right: 20px;z-index:1000; width: 20px;height: 20px;border-radius: 5px;color: red; opacity: 0.5; font-size: 10px">X</button>
    <div id="chatbot" style="position: fixed; bottom: 0; right: 20px;display: none;z-index:1000">
        <iframe
                allow="microphone;"
                width="350"
                height="430"
                src="https://console.dialogflow.com/api-client/demo/embedded/9237e06f-fd37-4b86-87ab-10a02f14d1bc">
        </iframe>
    </div>
</div>
<div class="container-fluid">
    ...
    <div class="wrapper_div">
        ...
        <div class="row row_main" style="height: 440px">
    ...
    <div class="row" style="margin-top: 20px;margin-bottom: 30px">
        <div class="main_wrap_suggested">
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-sm-4">
                        <h4>Your Recommended <span ><?php echo strtoupper($_SESSION['meal_time']);?> </span > Diet Plan</h4>
                    </div>
            ...
            <div class="panel-body" style="max-height: 350px; overflow: scroll">
                ...
                <div class="panel_body_wrapper">
                    <div class="row" >
                        <?php
                        $p_rand = rand(5, 10);
                        $query_separate = "select * from food_item where meal_categories = '".$_SESSION['meal_time']." meal' ORDER BY RAND() LIMIT ".$p_rand;
                        // print_r($query_separate); die();
                        $result = $con->query($query_separate);
                        $anss = array();
                        $result = mysqli_fetch_all($result,MYSQLI_ASSOC);
                        // print_r($result); die();
                        $sum_cal = 0;
                        for($j=0; $j<count($result); $j++){
                            $sum_cal += $result[$j]['calories'];
                            if($sum_cal < $_SESSION['calorie']){
                                array_push($anss,$result[$j]);
                            }
                        }
                        // print_r($anss[0]); die();
