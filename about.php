...
<!--                <img src="image/cover5.jpg" style="height: 200px;width:820px">-->
                <div class="col-sm-3">
                    ...
                    <span class="logo">Hygiea Personal Dietician</span>
                </div>
            </div>
            ...
            <div class="panel-body">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-sm-4">
                        <img src="image/ayum.jpg" style="height:200px;width: 200px">
                    </div>
                </div>
                <br>
                <br>
                ...
                <div class="panel-body">
                    <div class="col-sm-8">
                        <h4>Ravi Kiran Krovvidi</h4>
                    </div>
                    <div class="col-sm-4">
                        <img src="image/ravi.png" style="height:200px;width: 200px">
                    </div>
                </div>
                <br>
                <br>
                ...
                <div class="panel-body">
                    <div class="col-sm-8">
                        <h4>Jaspreet Kaur Narang</h4>
                    </div>
                    <div class="col-sm-4">
                        <img src="image/jas.png" style="height:200px;width: 200px">
                    </div>
                </div>
